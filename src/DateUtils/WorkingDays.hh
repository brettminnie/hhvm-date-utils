...
class WorkingDays
{
     ...
     */
    public function workingDaysFrom(?\DateTime $initialDate = null, string $workingDayOffset = '1') : \DateTime
    {
        if (null === $initialDate) {
     ...
     * @param string $workingDayOffset
     * @return \DateTime
     */
    public function workingDaysFromToday(string $workingDayOffset = '1') : \DateTime
    {
